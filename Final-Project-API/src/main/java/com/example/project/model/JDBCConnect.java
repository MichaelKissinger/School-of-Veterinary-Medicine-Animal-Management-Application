...
public class JDBCConnect {
    ...
    public String animalGetHistory(int animalID, String trait) throws SQLException {
        StringBuffer animalInfo = new StringBuffer();
        try {
            Statement myStmt = dbConnect.createStatement();
            ResultSet results = myStmt.executeQuery("SELECT * FROM HISTORY WHERE Animal_ID = \"" + animalID + "\";");
