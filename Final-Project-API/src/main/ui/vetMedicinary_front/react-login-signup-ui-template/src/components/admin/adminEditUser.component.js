            ...
            axios.put("http://localhost:8080/updateUserInfo/" + this.state.id, sendData)
                 .then(res => {
                     if (res.data==true){
                        ...
                        .then(function() {
                            // localStorage.removeItem("fname_editUser");
                            // localStorage.removeItem("lname_editUser");
                            // localStorage.removeItem("birth_editUser");
                            // localStorage.removeItem("phoneNumber_editUser");
                            // localStorage.removeItem("email_editUser");
